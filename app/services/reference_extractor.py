...
class ReferenceExtractor:
    ...
    def extract_references(
        self, text_blocks: List[Dict[str, Any]], page_idx: int = None
    ) -> List[Dict[str, Any]]:
            ...
            try:
                ...
                for pattern, ref_type, prefix in self.all_patterns:
                    for match in pattern.finditer(text_str):
                        all_matches.append(
                            {"match": match, "ref_type": ref_type, "prefix": prefix}
                        )
                ...
                for match_info in selected_matches:
                    ...
                    ref_bbox = self._estimate_ref_bbox(
                        bbox, text_str, start_pos, end_pos
                    )
    ...
    def _estimate_ref_bbox(
        self, text_bbox: Dict[str, int], full_text: str, start_pos: int, end_pos: int
    ) -> Dict[str, int]:
        ...
        try:
            ...
            return {"x": ref_x, "y": text_y, "width": ref_width, "height": text_height}
